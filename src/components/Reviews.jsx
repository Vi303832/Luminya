    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="font-heading text-4xl font-normal text-text-primary mb-4">Müşteri Yorumları</h2>
        ...
        {/* Review Card */}
        <div className="relative bg-olive rounded-2xl shadow-2xl p-8 md:p-12 text-white">
          {/* Quote Icon */}
          ...
          {reviews.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition ${
                currentIndex === index ? 'bg-olive w-8' : 'bg-stone-dark'
              }`}
            />
          ))}
        </div>
